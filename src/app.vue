...
<template>
  <div class="flex min-h-screen flex-col items-center justify-center">
    ...
    <UiContainer class="flex flex-col items-center">
      <span class="text-sm font-semibold uppercase tracking-wide text-primary-600">Mantenimiento</span>
      ...
      <span class="mt-2 text-lg text-gray-600"
        >¡Lo sentimos! Estamos mejorando nuestro sitio web para ti. Vuelve pronto.</span
      >
    </UiContainer>
